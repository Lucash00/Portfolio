...
export default function CardTimeline({ experience, variant = 'default' }) {
  ...
  if (variant === 'stacked') {
    return (
      <a
        ...
        className="group flex w-full min-w-0 max-w-full flex-col rounded-lg duration-300 ease-in-out"
      >
  ...
  return (
    <a
      href={experiencePath(experience.slug)}
      className="group flex min-w-0 max-w-full transform flex-col rounded-lg duration-300 ease-in-out sm:transform-none md:hover:-translate-y-1 md:hover:shadow-lg md:hover:shadow-gray-900"
    >
      <div className="card-accent-bar" aria-hidden="true" />
