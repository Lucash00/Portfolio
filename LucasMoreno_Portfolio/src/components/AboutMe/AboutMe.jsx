        ...
        <section className="flex flex-col lg:flex-row items-center justify-between px-6 py-12">
            ...
            <div className="w-full lg:w-2/3">
                <div className="sm:p-4 md:p-6 rounded-lg border-t-2 border-l-2 border-r-2 border-transparent bg-gradient-to-b from-gray-200 to-transparent dark:from-gray-700 dark:to-transparent ">
                    <h1 className="sm:text-2xl md:text-4xl lg:text-4xl xl:text-5xl 2xl:text-6xl sm:mb-4 md:mb-8 font-bold text-gray-800 dark:text-slate-200 ">
                        Hola, soy <span className="text-amber-400">Lucas Moreno</span>
                    </h1>
                    <p className="sm:text-base md:text-md lg:text-lg xl:text-xl 2xl:text-2xl text-gray-600 dark:text-gray-300 leading-relaxed text-justify">
